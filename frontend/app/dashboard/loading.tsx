    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0b1a2c]">
      ...
      <div className="max-w-5xl mx-auto px-4 py-5 grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-5 animate-pulse">
        <div className="space-y-4">
          {/* Welcome skeleton */}
          <div className="bg-white rounded-xl border border-gray-100 p-4 dark:bg-white/5 dark:border-[#d8ad43]/12">
          ...
          {/* Bookmarks skeleton */}
          <div className="bg-white rounded-xl border border-gray-100 p-4 dark:bg-white/5 dark:border-[#d8ad43]/12">
            <div className="h-4 bg-gray-100 rounded w-40 mb-4 dark:bg-white/8" />
            {[1,2,3,4,5].map(i => (
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-gray-100 p-4 dark:bg-white/5 dark:border-[#d8ad43]/12">
            <div className="w-11 h-11 rounded-full bg-gray-100 mb-3 dark:bg-white/8" />
