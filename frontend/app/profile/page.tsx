      ...
      <div className="mx-auto max-w-lg px-3 py-6 sm:px-4">
        <div className="campus-card rounded-2xl p-5">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-base font-semibold text-gray-800">{profile?.full_name ?? '-'}</p>
              <p className="truncate text-xs text-gray-400">{profile?.iuc_email ?? '-'}</p>
            </div>
          </div>
            ...
            <>
              <div className="mb-4 space-y-2.5">
                <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2.5">
                  <span className="text-xs text-gray-500">Öğrenci No</span>
                  <span className="text-xs font-medium text-gray-800">
                    {profile.student_no ?? <span className="text-gray-300">Belirtilmedi</span>}
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2.5">
                  <span className="text-xs text-gray-500">Sınıf</span>
                  <span className="text-xs font-medium text-gray-800">
