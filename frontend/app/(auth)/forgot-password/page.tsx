...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="w-full max-w-sm">
      {!sent ? (
        <>
          <h1 className="text-xl font-medium text-gray-900 mb-1">Şifre Sıfırla</h1>
          <p className="text-sm text-gray-500 mb-5">E-posta adresine sıfırlama linki gönderilecek</p>
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button type="submit" disabled={loading || !email}
              className="w-full h-10 bg-[#1E3A5F] text-white rounded-lg text-sm font-medium disabled:opacity-50">
        ...
        <div className="text-center">
          ...
          <h1 className="text-xl font-medium text-gray-900 mb-2">E-posta Gönderildi</h1>
