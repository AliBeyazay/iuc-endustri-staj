    ...
    SEARCH_QUERY_GROUPS = (
        {
            ...
            "queries": [
                # Core departments - Turkish (both "staj" and "stajyer")
                "endustri muhendisligi staj",
                "endustri muhendisligi stajyer",
                "tedarik zinciri staj",
                "tedarik zinciri stajyer",
                "kalite staj",
                "kalite stajyer",
                "uretim planlama staj",
                "uretim planlama stajyer",
                "operasyon staj",
                "operasyon stajyer",
                # Core departments - English
        ...
        },
        {
            ...
            "queries": [
                # Additional departments - Turkish
                "lojistik staj",
                "lojistik stajyer",
                "proje yonetimi staj",
                "proje yonetimi stajyer",
                "bakım onarım staj",
                "bakım onarım stajyer",
                "insan kaynaklari staj",
                "insan kaynaklari stajyer",
                "pazarlama staj",
                "pazarlama stajyer",
                "ar-ge staj",
                "ar-ge stajyer",
                ...
                "logistics intern turkey",
                "project management intern turkey",
                "maintenance intern turkey",
                "human resources intern turkey",
                "marketing intern turkey",
                "research development intern turkey",
                "process improvement intern turkey",
                "lean manufacturing intern turkey",
                "six sigma intern turkey",
                "continuous improvement intern turkey",
                "management trainee turkey",
                "long term intern turkey",
                "uzun donem stajyer",
                "genc yetenek programi",
                "yetenek programi stajyer",
                # Additional variants
                "mekatronik staj",
                "mekatronik stajyer",
                "elektrik muhendisligi staj",
                "elektrik muhendisligi stajyer",
                "makine muhendisligi staj",
                "makine muhendisligi stajyer",
                "harita muhendisligi staj",
                "harita muhendisligi stajyer",
                "beslenme staj",
                "beslenme stajyer",
            ],
        },
